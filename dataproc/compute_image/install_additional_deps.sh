...
gsutil -m cp -r gs://sangraha/setu_old/dataproc/envs/gcld3* /opt/conda/miniconda3/envs/setu_dataproc/lib/python3.10/site-packages
...
gsutil -m cp -r gs://sangraha/setu/setu/data/* /opt/setu/filter_data