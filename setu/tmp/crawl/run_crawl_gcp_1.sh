...
# for LANG in "Assamese" "Bodo" "Dogri";
# for LANG in "Gujarati" "Kannada" "Kashmiri" "Konkani" "Maithili" "Malayalam" "Manipuri" "Nepali" "Oriya" "Punjabi" "Santhali" "Sindhi";
# "Bengali"
for LANG in "English" "Marathi" "Tamil" "Telugu" "Urdu" "Hindi";
do
    CLUSTER_NAME="setu-debugging-40-highmem"
    ...
    gcloud dataproc jobs submit pyspark --cluster ${CLUSTER_NAME} \
        ...
        # --analysis_df_parquets_path "$GS_OUTPUT_ROOT/$SAVE_LANG/dataset/lid_segregation/doc_lid/dataset/*/*.parquet" \
