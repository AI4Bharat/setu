...
do
    ...
    #     --p2p_sort_col "page_no" \
    #     --p2p_symbol_join "" \
    #     --p2p_doc_stats_output_path "$GS_OUTPUT_ROOT/$SAVE_LANG/$OUTPUT_SHARD/analysis_page2pdfs/pdf_stats/dataset" \
    #     --p2p_doc_output_path "$GS_OUTPUT_ROOT/$SAVE_LANG/$OUTPUT_SHARD/analysis_page2pdfs/page2pdfs/dataset"
    ...
    #     # --analysis_doc_stats_parquets "$GS_OUTPUT_ROOT/$SAVE_LANG/$OUTPUT_SHARD/page2pdfs/pdf_stats/dataset/*.parquet" \
    ...
    #     --doc_stats_parquets_path "$GS_OUTPUT_ROOT/$SAVE_LANG/$OUTPUT_SHARD/analysis_page2pdfs/pdf_stats/dataset/*.parquet" \
    #     --is_doc_stats_path_batched False \
    #     --fnf_samples_per_partition 1500 \
    #     --fnf_verbose False \
    #     --fnf_run_mode stage \
    #     --save_nsfw_data True \
    #     --nsfw_output_path "$GS_OUTPUT_ROOT/$SAVE_LANG/$OUTPUT_SHARD/pdf_filtering/nsfw_doc_stats/dataset" \
    #     --filtered_doc_stats_output_path "$GS_OUTPUT_ROOT/$SAVE_LANG/$OUTPUT_SHARD/pdf_filtering/filtered_doc_stats/dataset"

    #     # --doc_stats_parquets_path  "$GS_OUTPUT_ROOT/$SAVE_LANG/$OUTPUT_SHARD/analysis/doc_stats_out/dataset/*/*.parquet" \
    ...
    gcloud dataproc jobs submit pyspark --cluster ${CLUSTER_NAME} \
        ...
        --run_local False \
        CustomJoinStage \
        --primary_parquets_path "$GS_OUTPUT_ROOT/$SAVE_LANG/$OUTPUT_SHARD/analysis/analysis/dataset/*/*.parquet" \
        --columns_from_primary_parquets "*" \
        --secondary_parquets_path "$GS_OUTPUT_ROOT/$SAVE_LANG/$OUTPUT_SHARD/pdf_filtering/filtered_doc_stats/dataset/*.parquet" \
        --columns_from_secondary_parquets "url" \
        --identifier_cols "doc_id" \
        --join_cols "url" \
        --join_type "inner" \
        --custom_join_run_mode "stage" \
        --joined_output_path "$GS_OUTPUT_ROOT/$SAVE_LANG/$OUTPUT_SHARD/filtering/filtered_docs/dataset" 
    ...
    gcloud dataproc jobs submit pyspark --cluster ${CLUSTER_NAME} \
        ...
        --analysis_out_path "$GS_OUTPUT_ROOT/$SAVE_LANG/$OUTPUT_SHARD/filtering/filtered_docs/dataset/*.parquet" \
        --doc_stats_path "$GS_OUTPUT_ROOT/$SAVE_LANG/$OUTPUT_SHARD/analysis/doc_stats_out/dataset/*/*.parquet" \
        ...
        # --analysis_out_path "$GS_OUTPUT_ROOT/$SAVE_LANG/$OUTPUT_SHARD/page2pdfs/page2pdfs/dataset/*.parquet" \
    ...
    gcloud dataproc jobs submit pyspark --cluster ${CLUSTER_NAME} \
        ...
        --run_local False \
        Page2PDFStage \
        --p2p_parquets_path "$GS_OUTPUT_ROOT/$SAVE_LANG/$OUTPUT_SHARD/filtered_docs/filtered_docs/dataset/*.parquet" \
        --p2p_doc_stats_path "$GS_OUTPUT_ROOT/$SAVE_LANG/$OUTPUT_SHARD/analysis/doc_stats_out/dataset/*/*.parquet" \
        --p2p_samples_per_partition 1500 \
        --p2p_data_quality "cleaned" \
        --p2p_text_col "text" \
        ...
        --p2p_sort_col "page_no" \
        --p2p_symbol_join "" \
        --p2p_doc_stats_output_path "$GS_OUTPUT_ROOT/$SAVE_LANG/$OUTPUT_SHARD/filtered_page2pdfs/pdf_stats/dataset" \
        --p2p_doc_output_path "$GS_OUTPUT_ROOT/$SAVE_LANG/$OUTPUT_SHARD/filtered_page2pdfs/page2pdfs/dataset"
    ...
    #     --run_local False \
    #     CustomJoinStage \
    #     --primary_parquets_path "$GS_OUTPUT_ROOT/$SAVE_LANG/$OUTPUT_SHARD/filtered_docs/filtered_docs/dataset/*.parquet" \
    #     --columns_from_primary_parquets "*" \
    #     --secondary_parquets_path "gs://sangraha/pdfs_out_dedup_pdf/minhash/$SAVE_LANG/*/*.parquet" \
    #     --columns_from_secondary_parquets "url" \
    #     --identifier_cols "doc_id" \
    #     --join_cols "url" \
    #     --join_type "inner" \
    #     --custom_join_run_mode "stage" \
    #     --joined_output_path "gs://sangraha/pdfs_out_dedup/minhash/$SAVE_LANG" 
done
