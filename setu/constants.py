...
class Constants():
    ...
    def load_junk_partial(self, junk_partial_glob):
        """load_junk_partial _summary_

        :param junk_partial_glob: _description_
        :type junk_partial_glob: _type_
        """
...
def create_kwpr(keywords):
    """
    This function creates and returns a keyword processor object given a keyword dictionary.

    :param keywords: A dictionary containing various keywords
    :type keywords: dict

    :return: A keyword processor object
    :rtype: flashtext KeywordProcessor object
    """
